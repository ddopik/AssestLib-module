...
public abstract class GPSTrackerSingleton extends Service implements LocationListener {
    ...
    public GPSTrackerSingleton(Context context) {
    ...
    public void stopUsingGPS() {
        if (locationManager != null) {
            locationManager.removeUpdates(GPSTrackerSingleton.this);
        }
    }
