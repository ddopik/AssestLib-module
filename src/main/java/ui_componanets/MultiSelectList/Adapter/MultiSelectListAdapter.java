package ui_componanets.MultiSelectList.Adapter;
...
//        Log.i("flag ", "Index before IF # --->" + defaultSource);
        if (defaultSource) {
            ...
            viewHolder.sourceListContainer.setBackgroundColor(Color.parseColor("#F16585"));
...
//            Log.i("flag ","WithOutClick defaultSource"+"if (true)   --->"+(defaultSource)+"------------>"+defaultSource);
            ...
            viewHolder.sourceListContainer.setBackgroundResource(0);
            viewHolder.source_name.setChecked(false);

        }

        viewHolder.sourceListContainer.setOnClickListener(new View.OnClickListener() {
            @Override
...
//                viewHolder.source_name.setChecked(!flag);
    ...
    public static class ViewHolder {
        ...
        LinearLayout sourceListContainer;
        CheckedTextView source_name;
        ImageView newsImage;

        public ViewHolder(View view) {
            sourceListContainer = view.findViewById(R.id.source_row_container);
            source_name = view.findViewById(R.id.row_list_checkedtextview);
            newsImage = view.findViewById(R.id.row_list_checkbox_image);
        }
    }
}
