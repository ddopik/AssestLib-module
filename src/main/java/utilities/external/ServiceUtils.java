...
public final class ServiceUtils {
    ...
    public static Set getAllRunningServices() {
        ActivityManager am =
                (ActivityManager) AppConfig.getApp().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public static void startService(final Class<?> cls) {
        Intent intent = new Intent(AppConfig.getApp(), cls);
        AppConfig.getApp().startService(intent);
    }
    ...
    public static boolean stopService(final Class<?> cls) {
        Intent intent = new Intent(AppConfig.getApp(), cls);
        return AppConfig.getApp().stopService(intent);
    }
    ...
    public static void bindService(final Class<?> cls,
                                   ...
                                   final int flags) {
        Intent intent = new Intent(AppConfig.getApp(), cls);
        AppConfig.getApp().bindService(intent, conn, flags);
    }
    ...
    public static void unbindService(final ServiceConnection conn) {
        AppConfig.getApp().unbindService(conn);
    }
